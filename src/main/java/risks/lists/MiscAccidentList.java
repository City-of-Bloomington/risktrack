...
public class MiscAccidentList{

    boolean debug = false;
    SimpleDateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
    static Logger logger = LogManager.getLogger(MiscAccidentList.class);
    ...
    String errors = "";
    List<MiscAccident> miscAccidents = null;
	
    public MiscAccidentList(boolean deb){
	debug = deb;
    }
    //
    // setters
	...
	try{
	    ...
	    miscAccidents = new ArrayList<>();
	    while(rs.next()){
		MiscAccident one =
		    new MiscAccident(debug,
				     rs.getString(1),
				     rs.getString(2),
				     rs.getString(3),
				     rs.getString(4),
